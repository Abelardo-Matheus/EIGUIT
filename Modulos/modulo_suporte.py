...
class TutorialSuporte:
    ...
    def __init__(self):
        ...
        self.conteudo = {
            0: [
                {'titulo': 'Sistema Drag & Drop', 'texto': "Para utilizar as escalas, ative o ícone do 'Alfinete' (canto superior direito). Com o modo de edição ativado, clique e arraste qualquer escala do painel inferior diretamente para o braço da guitarra.", 'thumb': 'Imagens/Thumbnails/Escalas/drag_drop.png'}, 
                {'titulo': 'Sobreposição Dinâmica', 'texto': 'Você pode soltar a escala em qualquer parte do braço. O EIGUIT recalcula automaticamente as notas baseando-se na afinação atual e no tom selecionado.', 'thumb': 'Imagens/Thumbnails/Escalas/sobreposicao.png'}, 
                {'titulo': 'Removendo Escalas', 'texto': 'Errou a posição ou quer limpar a tela? Basta clicar com o Botão Direito do mouse sobre o braço da guitarra para devolver todas as escalas de volta ao painel de origem.', 'thumb': 'Imagens/Thumbnails/Escalas/remover.png'}
            ], 
            1: [
                {'titulo': 'Personalização Visual', 'texto': 'Acesse a aba de configurações para alterar as cores do braço da guitarra e das notas. Use o seletor de cores integrado para encontrar o tom exato que mais agrada sua visão durante os estudos.', 'thumb': 'Imagens/Thumbnails/Configuracoes/visual.png'}, 
                {'titulo': 'Modos de Visualização', 'texto': "Você pode alternar o texto exibido dentro das bolinhas. Escolha entre 'Notas' (C, D, E), 'Graus' (1, 2, 3) para estudar intervalos, ou oculte o texto para focar apenas nos padrões visuais (shapes).", 'thumb': 'Imagens/Thumbnails/Configuracoes/modos.png'}, 
                {'titulo': 'Ajuste de Transparência', 'texto': 'Utilize o controle deslizante de Alpha (Transparência) para mesclar a visualização das escalas com a madeira da guitarra, criando uma interface menos agressiva aos olhos.', 'thumb': 'Imagens/Thumbnails/Configuracoes/transparencia.png'}
            ], 
            2: [
                {'titulo': 'Controle de Tempo (BPM)', 'texto': 'O metrônomo é o coração do seu estudo rítmico. Ajuste a velocidade usando os botões de + e - ou clique na barra deslizante. A faixa vai de 40 a 240 Batidas Por Minuto.', 'thumb': 'Imagens/Thumbnails/Metronomo/bpm.png'}, 
                {'titulo': 'Assinatura de Compasso', 'texto': 'Ajuste os tempos por compasso clicando nos números centrais (ex: 4/4, 3/4). O primeiro tempo (cabeça do compasso) sempre emitirá um som diferenciado para guiá-lo.', 'thumb': 'Imagens/Thumbnails/Metronomo/compasso.png'}
            ],
            3: [
                {'titulo': 'Busca de Acordes', 'texto': 'Utilize o painel de acordes para encontrar qualquer variação. Digite o nome da nota e o tipo (Maior, Menor, 7M, etc).', 'thumb': 'Imagens/Thumbnails/Acordes/busca.png'}, 
                {'titulo': 'Visualização no Braço', 'texto': 'Ao clicar em um acorde, ele é desenhado no braço da guitarra, mostrando as casas e dedos recomendados.', 'thumb': 'Imagens/Thumbnails/Acordes/braco.png'}
            ],
            4: [] # Aba de Vídeos
        }
        self.rects_videos = {}
    ...
    def _reproduzir_video(self, path):
        try:
            from Modulos.modulo_video_aula import abrir_player_video_async
