...
class TutorialSuporte:
    ...
    def __init__(self):
        ...
        self.conteudo = {0: [{'titulo': 'Sistema Drag & Drop', 'texto': "Para utilizar as escalas, ative o ícone do 'Alfinete' (canto superior direito). Com o modo de edição ativado, clique e arraste qualquer escala do painel inferior diretamente para o braço da guitarra."}, {'titulo': 'Sobreposição Dinâmica', 'texto': 'Você pode soltar a escala em qualquer parte do braço. O EIGUIT recalcula automaticamente as notas baseando-se na afinação atual e no tom selecionado.'}, {'titulo': 'Removendo Escalas', 'texto': 'Errou a posição ou quer limpar a tela? Basta clicar com o Botão Direito do mouse sobre o braço da guitarra para devolver todas as escalas de volta ao painel de origem.'}], 1: [{'titulo': 'Personalização Visual', 'texto': 'Acesse a aba de configurações para alterar as cores do braço da guitarra e das notas. Use o seletor de cores integrado para encontrar o tom exato que mais agrada sua visão durante os estudos.'}, {'titulo': 'Modos de Visualização', 'texto': "Você pode alternar o texto exibido dentro das bolinhas. Escolha entre 'Notas' (C, D, E), 'Graus' (1, 2, 3) para estudar intervalos, ou oculte o texto para focar apenas nos padrões visuais (shapes)."}, {'titulo': 'Ajuste de Transparência', 'texto': 'Utilize o controle deslizante de Alpha (Transparência) para mesclar a visualização das escalas com a madeira da guitarra, criando uma interface menos agressiva aos olhos.'}], 2: [{'titulo': 'Controle de Tempo (BPM)', 'texto': 'O metrônomo é o coração do seu estudo rítmico. Ajuste a velocidade usando os botões de + e - ou clique na barra deslizante. A faixa vai de 40 a 240 Batidas Por Minuto.'}, {'titulo': 'Assinatura de Compasso', 'texto': 'Ajuste os tempos por compasso clicando nos números centrais (ex: 4/4, 3/4). O primeiro tempo (cabeça do compasso) sempre emitirá um som diferenciado para guiá-lo.'}, {'titulo': 'Controles Flutuantes', 'texto': 'Mantenha o mini-metrônomo onde for mais conveniente na tela. Ele continuará tocando em segundo plano mesmo enquanto você interage com outras janelas.'}], 3: [{'titulo': 'O Campo Harmônico', 'texto': 'A janela de acordes arrastáveis exibe o campo harmônico completo da tônica escolhida. Clique em qualquer acorde para destacá-lo imediatamente no braço da guitarra.'}, {'titulo': 'Destaque de Graus', 'texto': 'Ao clicar em um acorde, o EIGUIT pinta automaticamente as Tônicas, Terças e Quintas (Tríade) específicas daquele acorde, ajudando na visualização de arpejos ao longo do braço.'}, {'titulo': 'Mudança Global de Tom', 'texto': 'Ao alterar a tônica ou o tipo de escala no módulo do Campo Harmônico, todo o sistema (incluindo as escalas do painel inferior) se adapta instantaneamente para o novo tom.'}], 4: [{'titulo': 'Afinador e Detecção', 'texto': 'Conecte seu microfone nas configurações de áudio. O sistema analisará a frequência da sua guitarra em tempo real, indicando na tela exatamente qual nota está sendo tocada.'}, {'titulo': 'Treinamento Rítmico', 'texto': 'Use a IA para avaliar sua precisão. O EIGUIT escuta suas palhetadas e cruza as informações com o BPM do metrônomo, indicando se você está adiantando ou atrasando o tempo.'}, {'titulo': 'Gamificação (Jogos)', 'texto': 'Aprenda brincando. Acesse a aba de jogos para desafios interativos onde você precisa acertar as notas no tempo correto, ganhando pontos e elevando seu nível prático.'}]}
