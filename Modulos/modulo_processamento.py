...
class ProcessadorAudio:
    ...
    # --- MÉTODOS DE RITMO REMOVIDOS (MOVIDOS PARA JOGOS/JOGO2.PY) ---
    ...
    def desenhar_aba_ia(self, tela, offset_x, y_caixa, rect_botao, gravador, fonte_ui, fonte_titulo, notas_abertas, estado):
        ...
        distancia_x = 220  # Ajustado para alinhar perfeitamente
        
        y_suav = y_caixa + 20
        tela.blit(fonte_ui.render("Estabilidade da Agulha:", True, self.CINZA), (x_calib, y_suav + 5))
        ...
        y_sens = y_caixa + 70
        tela.blit(fonte_ui.render("Rigor da Frequência:", True, self.CINZA), (x_calib, y_sens + 5))
