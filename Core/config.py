...
class Configuracoes:
    ...
    def desenhar(self, tela, fonte_titulo, fonte_ui, scroll_y=0):
        ...
        def container(x, y, titulo):
            ...
            tela.blit(fonte_ui.render(titulo, True, self.AZUL_DESTAQUE), (x + 15, y + 10))
            return y + 45

        # Bloco 1
        y_int = container(x_atual, y_atual, "Ajustes de Áudio")
        tela.blit(fonte_ui.render(f"Transparência: {self.transparencia}%", True, self.BRANCO), (x_atual + 15, y_int))
        ...
        y_int += 65
        tela.blit(fonte_ui.render(f"Volume FX: {self.volume_fx}%", True, self.BRANCO), (x_atual + 15, y_int))
        ...
        tela.blit(fonte_ui.render("Cor Madeira", True, self.BRANCO), (self.rect_btn_cor_braco.right + 15, y_int + 15))
        ...
        tela.blit(fonte_ui.render("Cor Notas", True, self.BRANCO), (self.rect_btn_cor_notas.right + 15, y_int + 80))
        ...
        tela.blit(fonte_ui.render("Efeitos de Partículas", True, self.BRANCO), (self.rect_btn_particulas.right + 10, y_int + 2))
        y_int += 50
        tela.blit(fonte_ui.render(f"Velocidade Jogos: {self.velocidade_jogo}x", True, self.BRANCO), (x_atual + 15, y_int))
        ...
        tela.blit(fonte_ui.render("Tema de Cores:", True, self.BRANCO), (x_c2 + 15, y_int))
        ...
        txt_t = fonte_ui.render(self.temas[self.indice_tema], True, self.BRANCO)
        tela.blit(txt_t, (x_c2 + 100 - txt_t.get_width()//2, y_int + 35))
        y_int += 75
        tela.blit(fonte_ui.render(f"Escala Notas: {self.tamanho_notas}x", True, self.BRANCO), (x_c2 + 15, y_int))
        ...
        for i, n in enumerate(self.nomes_modos):
            ...
            tela.blit(fonte_ui.render(n, True, self.BRANCO), (r.x + 10, r.y + 3))
