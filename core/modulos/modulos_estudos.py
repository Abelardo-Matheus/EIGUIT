...
class EstudoAcordes:
    """
        Como funciona: Define a estrutura e estado do componente 'EstudoAcordes'.
        Para que serve: Controla a lógica e interação da tela de estudo prático.
        Onde é usada: Chamado a partir do módulo ou classe base de 'modulos_estudos'.
    """
    ...
    def __init__(self):
        ...
        self.lista_acordes = ['C Maior', 'A Maior', 'G Maior', 'E Maior', 'D Maior', 'C Menor', 'A Menor', 'E Menor', 'C7', 'A7', 'G7', 'E7', 'D7']
        import core.modulos.modulos_acordes as mod_acordes
        self.shapes = {'C Maior': mod_acordes.TRIADE_C_MAIOR, 'A Maior': mod_acordes.TRIADE_A_MAIOR, 'G Maior': mod_acordes.TRIADE_G_MAIOR, 'E Maior': mod_acordes.TRIADE_E_MAIOR, 'D Maior': mod_acordes.TRIADE_D_MAIOR, 'C Menor': mod_acordes.TRIADE_C_MENOR, 'A Menor': mod_acordes.TRIADE_A_MENOR, 'E Menor': mod_acordes.TRIADE_E_MENOR, 'C7': mod_acordes.C7, 'A7': mod_acordes.A7, 'G7': mod_acordes.G7, 'E7': mod_acordes.E7, 'D7': mod_acordes.D7}
...
class GerenciadorEstudos:
    """
        Como funciona: Define a estrutura e estado do componente 'GerenciadorEstudos'.
        Para que serve: Controla a lógica e interação da tela de estudo prático.
        Onde é usada: Chamado a partir do módulo ou classe base de 'modulos_estudos'.
    """
    ...
    def desenhar_tela_estudo(self, tela, largura, altura, estado, fontes):
        """
            Como funciona: Utiliza funções de renderização do Pygame para desenhar na tela.
            Para que serve: Apresenta o elemento visual 'tela estudo' na interface gráfica.
            Onde é usada: Chamado a partir do módulo ou classe base de 'modulos_estudos'.
        """
        tela.fill((20, 20, 25))
        ...
        if estado.estudo_ativo in ['Notas', 'Acerte a Nota', 'Acerte o Som', 'Acerte a Próxima']:
            if self.modulo_notas is None:
                ...
                if estado.estudo_ativo == 'Acerte o Som':
                    self.modulo_notas.modo_jogo = 'ouvir'
            ...
            if self.modulo_acordes is None:
                self.modulo_acordes = EstudoAcordes()
            self.modulo_acordes.desenhar(tela, estado, fontes, meio_x, meio_y, cam_x, cam_y)
        elif estado.estudo_ativo == 'Prática de Acordes':
            if self.modulo_acordes_pratico is None:
                self.modulo_acordes_pratico = estudo_acordes_pratico.EstudoAcordesPratico()
            ...
            self.modulo_ciclo.desenhar(tela, estado, fontes, meio_x, meio_y, cam_x, cam_y)
        else:
    ...
    def _limpar_modulos(self):
        """
            Como funciona: Executa o fluxo lógico necessário para a operação ' limpar modulos'.
            Para que serve: Realiza as tarefas fundamentais de ' limpar modulos' dentro do contexto do módulo.
            Onde é usada: Utilizado internamente para gerenciar comportamentos de ' limpar modulos'.
        """
        self.modulo_notas = None
        self.modulo_escalas = None
        self.modulo_acordes = None
