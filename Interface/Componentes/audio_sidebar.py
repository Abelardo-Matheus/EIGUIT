...
from Interface.Componentes.config_componentes import (
    SIDEBAR_NOTA_OFFSET_X, SIDEBAR_NOTA_OFFSET_Y, SIDEBAR_LABEL_OFFSET_Y,
    SIDEBAR_GRID_NOTAS_Y, SIDEBAR_SLIDER_OFFSET_Y, SIDEBAR_SLIDER_ALTURA_PROX
)
...
def desenhar_bloco_nota_atual(tela, estado, fontes):
    ...
    tela.blit(txt_nota, (x_base + SIDEBAR_NOTA_OFFSET_X, y_base + SIDEBAR_NOTA_OFFSET_Y))
    
    txt_label = fontes['pequena'].render(_t("Entrada de Áudio"), True, (150, 150, 150))
    tela.blit(txt_label, (x_base + SIDEBAR_NOTA_OFFSET_X, y_base + SIDEBAR_LABEL_OFFSET_Y))
