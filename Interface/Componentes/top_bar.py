...
def desenhar_painel_superior(tela, estado, fontes, configs):
    """
        ...
        Para que serve: Apresenta o elemento visual 'painel superior' na interface gráfica.
        Onde é usada: Chamado a partir do módulo ou classe base de 'top_bar'.
    """
    ...
    pygame.draw.rect(tela, cor_tema if instrumento == 'guitarra' else (60, 60, 60), estado.btn_guit, border_radius=6)
    ...
    pygame.draw.rect(tela, cor_tema if instrumento == 'baixo' else (60, 60, 60), estado.btn_baixo, border_radius=6)
